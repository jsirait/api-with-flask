...
from middleware import read_widgets, read_widget_by_id, create_widget, delete_widget
...
def initialize_routes(app):
    if app:
        ...
        app.add_url_rule('/api/widgets', 'delete_widget', delete_widget, methods=['DELETE'])
